...
with s1:
    st.success(
        "1. เปลี่ยนจากการให้สิทธิ์ลูกค้า In-house ข้ามคิวได้ก่อน เป็นการการันตีที่นั่ง 60% ให้กับลูกค้า In-house เพื่อให้มีที่นั่งเพียงพอ และเปิด 40% ให้กับลูกค้า Walk-in จองคิวล่วงหน้าผ่านระบบออนไลน์ เพื่อไม่ให้ลูกค้า Walk-in รอนานเกิน วิธีนี้จะทำให้ยังคงรักษาลูกค้าไว้ได้ทั้ง 2 ทาง"
    )
with s2:
    st.warning(
        "2. จาก visuls 3 ของ Task2 จะเห็นว่า 83.7% ของกลุ่มลูกค้าคือกลุ่มเล็ก 1-2 คน ถ้าหากเราปรับแยกโต๊ะรวมขนาดใหญ่ ให้กลายเป็นโต๊ะย่อย 1-2 ที่นั่งได้ เราจะสามารถรองรับลูกค้ากลุ่มเล็กได้มากขึ้น ซึ่งเป็นลูกค้าส่วนใหญ่"
    )
